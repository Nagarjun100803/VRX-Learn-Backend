...
from src.query.dto.assignment_contents import AssignmentSubmissionFilters, AssignmentSubmissionQuerySchema, TraineeAssignmentContent, TraineeAssignmentCore, TrainerAssignmentContent, TrainerAssignmentCore, TrainerSubmissionDetail
...
@trainee_router.get("/assignments/{course_id}", response_model=list[TraineeAssignmentCore])
...
@trainee_router.get("/contents/{assignment_id}", response_model=TraineeAssignmentContent)
...
@trainer_router.get("/assignments/{course_id}", response_model=list[TrainerAssignmentCore])
async def list_assignments(
    course_id: CourseID,
...
@trainer_router.get("/submissions/{assignment_id}", response_model=Paginated[TrainerSubmissionDetail])
...
@trainer_router.get("/contents/{assignment_id}", response_model=TrainerAssignmentContent)
