...
from src.api.routers.authentication import router as AuthenticationRouter
...
from src.api.routers.course_overview import (
    trainee_course_preview_router as TraineeCoursePreviewAPIRouter,
)
from src.api.routers.course_overview import (
