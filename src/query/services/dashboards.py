...
class TraineeDashboardQueryService:
    def __init__(
        self, trainee_dashboard_query_repo: TraineeDashboardQueryRepository
    ) -> None:
...
class TrainerDashboardQueryService:
    def __init__(
        self, trainer_dashboard_query_repo: TrainerDashboardQueryRepository
    ) -> None:
...
class AdminDashboardQueryService:
    def __init__(
        self, admin_dashboard_query_repo: AdminDashboardQueryRepository
    ) -> None:
