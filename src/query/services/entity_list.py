...
from src.query.dto.entity_list import AssignmentDetail, AssignmentDetailWithDue, CourseDetail, CourseFilters, EnrollmentDetail, EnrollmentFilters, LessonDetail, ModuleDetail, TraineeFilters, UserDetail, UserFilters
