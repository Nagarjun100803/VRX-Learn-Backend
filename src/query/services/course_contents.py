...
class TraineeCourseContentQueryService:
    ...
    async def get_course_contents(self, query: CourseContentRequestSchema) -> TraineeCourseContent:
        return await self.trainee_course_content_repo.course_contents(course_id=query.course_id)
...
class TrainerCourseContentQueryService:
    ...
    async def get_course_contents(self, query: CourseContentRequestSchema) -> TrainerCourseContent:
        return await self.trainer_course_content_repo.course_contents(course_id=query.course_id)
